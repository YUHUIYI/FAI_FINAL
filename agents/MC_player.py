# agents/MC_player.py
"""
Monte-Carlo (fast) ─ 只會 CALL 或 ALL-IN
---------------------------------------
‣ 估算 equity → 選 EV 較大的動作  
‣ 永遠不 fold
"""
...
class FastMonteCarloPlayer(BasePokerPlayer):
    ...
    def declare_action(self, valid_actions, hole_card, round_state):
        equity = self._equity(hole_card, round_state)            # 0-1
